        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkBack = table.Column<string>(nullable: true),
                    DataBackTemplate = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Action_Template_TemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sentence_Template_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "Template",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Result_Action_ActionId",
                        column: x => x.ActionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Data_Sentence_SentenceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Action_TemplateId",
                table: "Action",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_Data_SentenceId",
                table: "Data",
                column: "SentenceId");

            migrationBuilder.CreateIndex(
                name: "IX_Result_ActionId",
                table: "Result",
                column: "ActionId");

            migrationBuilder.CreateIndex(
                name: "IX_Sentence_TemplateId",
                table: "Sentence",
                column: "TemplateId");
